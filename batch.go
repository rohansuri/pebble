...
func (i *batchIter) String() string {
	return fmt.Sprintf("err=%v, %s", i.err, i.iter.String())
}
...
func (i *flushableBatchIter) String() string {
	return fmt.Sprintf("key=%v, err=%v", i.Key(), i.err)
}
...
func (i *flushFlushableBatchIter) String() string {
	return fmt.Sprintf("flushFlushableBatchIter[flushableBatchIter=%s]", i.flushableBatchIter.String())
}
